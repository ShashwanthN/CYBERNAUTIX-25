...
export const PinContainer = ({ children, title, to, className, containerClassName }) => {
  ...
  return (
    <Link
      ...
      to={to || "/"} // ✅ Replaced href with to for React Router
    >
...
export const PinPerspective = ({ title, to }) => {
  return (
